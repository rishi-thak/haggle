  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "tilt-in": {
          "0%": { opacity: "0", transform: "translateY(8px) rotate(-6deg) scale(0.9)" },
          "60%": { transform: "translateY(-2px) rotate(2deg) scale(1.02)" },
      ...
      animation: {
        ...
        "tilt-in": "tilt-in 600ms cubic-bezier(0.34, 1.56, 0.64, 1) both",
